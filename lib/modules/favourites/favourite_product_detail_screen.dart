...
class FavouriteProductDetailsScreen extends StatefulWidget {
  static const routeName = '/FavouriteProductDetailsScreen';

  final int index;
  final int id;

  const FavouriteProductDetailsScreen({this.index , this.id}) ;

  @override
  _FavouriteProductDetailsScreenState createState() => _FavouriteProductDetailsScreenState();
}

class _FavouriteProductDetailsScreenState extends State<FavouriteProductDetailsScreen> {
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          ...
                          maxLines:!discriptionBoxFit? 4 :productModel.description.codeUnits.length  ,
                          softWrap: true,
                          style: TextStyle(
              ...
              Container(
                ...
                child: ListView.separated(
                 ...
                 // shrinkWrap: true,
                  ...
                  return buildProductItem(model.data.products[index_1] , context ,model.data.products[index_1].id);
                  },
          ...
          Expanded(
            ...
            child: Container(
              ...
              child: RaisedButton(
                ...
                onPressed: ()async {
                  if(cartModel.cartItems.containsKey(productModel.id.toString()))
                   {
                    cartModel.checkItemInCart(productModel.id.toString());}
                   else {
                  cartModel.addProductToCart(name: productModel.name ,
                  price:productModel.price  , 
                  oldPrice:productModel.oldPrice??0.0 ,
                  id:productModel.id.toString() ,
                  image:productModel.image,
                  discount :productModel.discount,
                 // index: (widget.id/4).toInt(),
                  );
                ...
                child: Text(
                  cartModel.cartItems.containsKey(productModel.id.toString())?'In Cart'.toUpperCase():
          ...
          Expanded(
            ...
            child:  Container(
              ...
              child: LikeButton(
                  ...
                  isLiked: HomeCubit.get(context).favourites[productModel.id],
                  onTap: (val) async {
                    HomeCubit.get(context).changeFavourites(productModel.id);
  ...
  Widget _details( String title, String info) {
   ...
   Widget buildProductItem( model, context ,index) {
    return Container(
      ...
      child: InkWell(
        onTap: (){
          Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context ) => FavouriteProductDetailsScreen(id: index ,)));
          },
